...
### Option 1: Deploy to Rococo Contracts (Testnet)

Rococo Contracts is a Polkadot testnet that supports smart contracts.

1. Get ROC tokens from [Rococo Faucet](https://paritytech.github.io/polkadot-testnet-faucet/)

2. Deploy via [Contracts UI](https://contracts-ui.substrate.io/):
   - Switch network to "Rococo Contracts"
   - Upload your `.contract` file
   - Deploy and instantiate

### Option 2: Deploy to Asset Hub (Kusama Parachain)

Asset Hub supports NFTs natively. For ink! contracts, you need:

1. Find a Kusama parachain that supports ink! contracts (e.g., Astar, Shiden)

2. Get KSM or parachain tokens

3. Deploy via parachain's contract UI or CLI

### Option 3: Using cargo-contract CLI
...
# Deploy to testnet (Rococo Contracts)
cargo contract instantiate \
  --constructor new \
